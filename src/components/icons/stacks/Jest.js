const Jest = (props) => (
  <svg viewBox='0 0 398.3 439.9' {...props}>
    ...
    <path d='M264.9 91.2L319.2 202l65.1-192h-239l65 191.6z' fill='none' stroke='#fff' strokeWidth={20} />
    ...
    <circle cx={65.1} cy={216.9} fill='none' r={40.9} stroke='#fff' strokeWidth={20} />
  </svg>
)
