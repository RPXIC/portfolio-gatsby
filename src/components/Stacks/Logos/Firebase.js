const Firebase = (props) => (
  <svg viewBox='0 0 256 351' preserveAspectRatio='xMidYMid' {...props}>
    <defs>
      ...
      <path d='M1.253 280.732l1.605-3.131 99.353-188.518-44.15-83.475C54.392-1.283 45.074.474 43.87 8.188L1.253 280.732z' id='prefix__a' />
      <path d='M134.417 148.974l32.039-32.812-32.039-61.007c-3.042-5.791-10.433-6.398-13.443-.59l-17.705 34.109-.53 1.744 31.678 58.556z' id='prefix__c' />
    </defs>
